(function () {
  ...
  if (!games.length) {
    if (sub) sub.textContent = "FINAL 2025–26 · no game results in this archive snapshot";
    root.innerHTML =
      '<div class="hl-empty">' +
      ...
      '<p class="hl-empty-links">See the <a href="schedule.html">Schedule</a> · <a href="../../index.html">live 2026–27 site</a>.</p>' +
      "</div>";
    return;
  }
